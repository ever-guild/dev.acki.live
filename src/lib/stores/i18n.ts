...
const translations: Translations = {
  en: {
    ...
    'transactions.details.outputMsg': 'Output Messages',
  ...
  ru: {
    ...
    'transactions.details.outputMsg': 'Исходящие сообщения',
    'transactions.details.from': '@:common.from',
    'transactions.details.to': '@:common.to',
    'transactions.details.value': '@:common.value',
    ...
    'account.neverPaid': 'Еще не было выплат',
    'account.name': 'Имя',
    ...
    'account.notFound': 'Аккаунт не найден',
